...
<div class="log_bg">
    <div class="top">
        <div class="logo"><a href="${pageContext.request.contextPath}/index.jsp"><img src="images/logo.png"/></a></div>
    </div>
    <div class="regist">
            ...
            <form>
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><input id="password_repeat" type="password" value="" class="l_pwd"/></td>
                    </tr>
                    <tr height="50">
                    ...
                    <tr height="50">
                        ...
                        <td><input id="phone" type="text" value="" class="l_tel"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr height="60">
                        <td>&nbsp;</td>
                        <td><input id="submit" value="立即注册" class="log_btn"/></td>
                    </tr>
                </table>
            </form>
        </div>
