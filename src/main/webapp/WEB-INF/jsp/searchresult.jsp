        ...
        <span class="fr">
        	<span class="fl">
                    <c:if test="${sessionScope.user==null}">
                        ...
                        <a href="${pageContext.request.contextPath}/regist" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;
                    </c:if>
                    <c:if test="${sessionScope.user!=null}">
                        你好,
...
<div class="i_bg">
    ...
    <div class="content mar_10">
        <table border="0" class="choice" style="width:100%; font-family:'宋体'; margin:0 auto;" cellspacing="0"
            ...
            <tr valign="top">
                <td width="70">&nbsp; 品牌：</td>
                <td class="td_a"><a href="#">香奈儿（Chanel）</a><a href="#">迪奥（Dior）</a><a
            ...
            <tr valign="top">
                <td>&nbsp; 价格：</td>
                <td class="td_a"><a href="#">0-199</a><a href="#">200-399</a><a href="#">400-599</a><a
...
<script type="text/javascript">
    ...
    function showGoodItem(result) {
        ...
        $.each(goods, function (index, item) {
            var goodImage = $(" <div class=\"img\"><a Unhref=\"#\"><img src=\"images/" + item.image + "\" width=\"210\" height=\"185\"/></a></div>")
            var goodPrice = $("<div class=\"price\"><font color=\"#ff4e00\">￥" + item.price + "</font> X1</div>")
